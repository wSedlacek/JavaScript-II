...
// Problem 2
// A hacking group has contacted you and they need the page to come up with an alert showing all the personal data and donation ammount of each runner when the page is loaded.
//runners.forEach(runner => alert(`${runner.full_name} - ${runner.email} - $${runner.donation} `));

// Problem 3
// The shirt service changed the names of all their sizes. Correct the sizes as follows:
// XS => 0
// S => 1
// M => 10
// L => 11
...
runners.forEach(runner => {
  ...
  runner.shirt_size = size;
});

console.log(runners.map(runner => runner['shirt_size']));
