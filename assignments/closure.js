...
const testClosure = closure();
console.log(testClosure('Hi!'));
console.log(testClosure(" You should have 'Hi!' at the start of this line"));
...
console.log(`This should be 1: ${counter()}`);
console.log(`This should be 2: ${counter()}`);

// ==== Challenge 3: Make `counterMaker` more sophisticated ====
// It should have a `limit` parameter. Any counters we make with `counterMaker`
// will refuse to go over the limit, and start back at 1.
const counterMakerV2 = (limit = 10) => {
  let count = 1;
  return () => {
...
const counterV3 = counterFactory();
